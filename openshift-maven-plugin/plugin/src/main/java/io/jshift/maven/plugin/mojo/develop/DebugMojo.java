...
import io.jshift.maven.enricher.api.util.DebugConstants;
...
import static io.jshift.kit.common.util.KubernetesHelper.getPodLabelSelector;
...
public class DebugMojo extends ApplyMojo {
    ...
    @Parameter(property = "jshift.debug.port", defaultValue = "5005")
    private String localDebugPort;

    @Parameter(property = "jshift.debug.suspend", defaultValue = "false")
