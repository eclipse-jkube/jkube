...
import io.jkube.kit.common.util.ResourceClassifier;
import io.jkube.kit.common.util.ResourceUtil;
import io.jkube.kit.common.util.ValidationUtil;
import io.jkube.kit.common.util.validator.ResourceValidator;
...
import io.jkube.kit.config.resource.MappingConfig;
...
import io.jkube.kit.profile.Profile;
...
import io.jkube.maven.plugin.enricher.EnricherManager;
...
import static io.jkube.kit.common.ResourceFileType.yaml;
...
public class ResourceMojo extends AbstractJkubeMojo {
    ...
    public void executeInternal() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            ...
            throw new MojoExecutionException("Failed to generate openshift descriptor", e);
        }
    }
    ...
    private void validateIfRequired(File resourceDir, ResourceClassifier classifier)
        ...
        try {
            ...
            if (failOnValidationError) {
                ...
                throw new MojoFailureException("Failed to generate openshift descriptor");
            } else {
    ...
    private Date getBuildReferenceDate() throws MojoExecutionException {
        // Pick up an existing build date created by oc:build previously
