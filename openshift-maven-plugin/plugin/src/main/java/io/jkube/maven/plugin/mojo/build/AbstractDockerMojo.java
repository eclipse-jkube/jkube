...
import io.jkube.kit.build.service.docker.config.DockerMachineConfiguration;
import io.jkube.kit.build.service.docker.config.WatchMode;
import io.jkube.kit.build.service.docker.config.handler.ImageConfigResolver;
...
import io.jkube.kit.build.service.docker.helper.ImageNameFormatter;
...
import io.jkube.kit.config.image.build.RegistryAuthConfiguration;
...
public abstract class AbstractDockerMojo extends AbstractMojo implements ConfigHelper.Customizer, Contextualizable {
    public static final String DMP_PLUGIN_DESCRIPTOR = "META-INF/maven/io.jkube/k8s-plugin";
    ...
    protected io.jkube.kit.config.service.BuildService.BuildServiceConfig getBuildServiceConfig() throws MojoExecutionException {
        return new io.jkube.kit.config.service.BuildService.BuildServiceConfig.Builder()
