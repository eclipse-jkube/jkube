...
@Mojo(name = "helm-uninstall", defaultPhase = LifecyclePhase.INSTALL, requiresDependencyResolution = ResolutionScope.COMPILE)
public class OpenshiftHelmUninstallMojo extends HelmUninstallMojo {
  /**
   * One of:
   * <ul>
