...
public class PortForwardService {
     ...
     */
    public Closeable forwardPortAsync(final KitLogger externalProcessKitLogger, final LabelSelector podSelector, final int remotePort, final int localPort) throws JshiftServiceException {
    ...
    public void forwardPort(KitLogger externalProcessKitLogger, String pod, int remotePort, int localPort) throws JshiftServiceException {
        forwardPortAsync(externalProcessKitLogger, pod, remotePort, localPort).await();
    }

    public ProcessUtil.ProcessExecutionContext forwardPortAsync(KitLogger externalProcessKitLogger, String pod, int remotePort, int localPort) throws JshiftServiceException {
        ...
        try {
            ...
            throw new JshiftServiceException("Error while executing the port-forward command", e);
        }
    }
}
