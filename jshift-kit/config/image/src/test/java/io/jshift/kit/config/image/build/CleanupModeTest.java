...
import static io.jshift.kit.config.image.build.CleanupMode.NONE;
import static io.jshift.kit.config.image.build.CleanupMode.REMOVE;
import static io.jshift.kit.config.image.build.CleanupMode.TRY_TO_REMOVE;
