...
import io.jshift.generator.webapp.handler.JettyAppSeverHandler;
import io.jshift.generator.webapp.handler.TomcatAppSeverHandler;
import io.jshift.generator.webapp.handler.WildFlyAppSeverHandler;
...
class AppServerDetector {
    ...
    private final List<? extends io.jshift.generator.webapp.AppServerHandler> serverHandlers;
