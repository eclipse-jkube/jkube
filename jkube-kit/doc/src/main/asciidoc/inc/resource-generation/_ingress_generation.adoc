...
| `ingressClassName`
| Name of the IngressClass to use for this Ingress. Useful for selecting a specific Ingress controller in clusters with multiple controllers (e.g., nginx, traefik, HAProxy).
