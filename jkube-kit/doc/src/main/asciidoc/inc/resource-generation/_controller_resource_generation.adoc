...
| <<resource-requests-limits-configuration, `resourceRequestsLimits`>>
...
==== Resource Requests/Limits {plugin-configuration-type} configuration

.resourceRequestsLimits fields for specifying compute resource requirements
[cols="1,5"]
|===
| Element | Description
