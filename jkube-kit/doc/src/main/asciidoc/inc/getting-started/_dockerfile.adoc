...
You can take a look at https://github.com/eclipse-jkube/jkube/tree/master/quickstarts/gradle/docker-file-provided-docker-file[Docker File Provided Quickstarts] for more details.
