...
class IngressEnricherTest {
    ...
    void createIngressFromXMLConfigWithConfiguredServiceName() {
        ...
        assertThat(kubernetesListBuilder)
            .extracting(KubernetesListBuilder::buildItems).asInstanceOf(InstanceOfAssertFactories.list(Ingress.class))
            .hasSize(2)
            ...
            .satisfies(is -> assertThat(is).extracting("tls").asInstanceOf(InstanceOfAssertFactories.list(IngressTlsConfig.class)).element(0)
            ...
            .satisfies(r -> assertThat(r).asInstanceOf(InstanceOfAssertFactories.list(IngressRule.class)).element(0)
                ...
                .extracting("http.paths").asInstanceOf(InstanceOfAssertFactories.list(IngressRulePathConfig.class)).element(0)
