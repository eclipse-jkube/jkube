...
public class ControllerViaPluginConfigurationEnricher extends BaseEnricher {
    ...
    public void create(PlatformMode platformMode, KubernetesListBuilder builder) {
        final String name = getConfig(ControllerViaPluginConfigurationEnricher.Config.NAME, JKubeProjectUtil.createDefaultResourceName(getContext().getGav().getSanitizedArtifactId()));
