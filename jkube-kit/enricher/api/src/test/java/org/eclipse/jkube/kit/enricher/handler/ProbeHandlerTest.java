...
class ProbeHandlerTest {
    ...
    void httpGetProbe_withCustomHeaders() {
        ...
        assertThat(probe).isNotNull()
            ...
            .satisfies(p -> assertThat(p).extracting("httpGet.httpHeaders").asInstanceOf(InstanceOfAssertFactories.list(HTTPHeader.class)).element(0)
                .hasFieldOrPropertyWithValue("name", "Accept")
                .hasFieldOrPropertyWithValue("value", "application/json")
            )
            .satisfies(p -> assertThat(p).extracting("httpGet.httpHeaders").asInstanceOf(InstanceOfAssertFactories.list(HTTPHeader.class)).element(1)
