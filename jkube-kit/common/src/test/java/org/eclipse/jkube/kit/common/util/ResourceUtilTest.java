...
public class ResourceUtilTest {
  ...
  @Test
  public void deserializeKubernetesListOrTemplate_withMixedResources_returnsValidList() throws IOException, URISyntaxException {
    // Given
    final File kubernetesListFile = resourceTestFile(
            "/util/resource-util/list-with-standard-template-and-cr-resources.yml");
    // When
  ...
  @Test
  public void deserializeKubernetesListOrTemplate_withTemplateFile_returnsValidList() throws IOException, URISyntaxException {
    // Given
    final File kubernetesListFile = resourceTestFile("/util/resource-util/template.yml");
    // When
    final List<HasMetadata> result = ResourceUtil.deserializeKubernetesListOrTemplate(
        kubernetesListFile);
    // Then
  ...
  @Test
  public void deserializeKubernetesListOrTemplate_withMultipleYamlAndSeparator_returnsValidList() throws IOException, URISyntaxException {
    // Given
    final File kubernetesListFile = resourceTestFile("/util/resource-util/multiple-k8s-documents.yml");
    // When
    final List<HasMetadata> result = ResourceUtil.deserializeKubernetesListOrTemplate(
        kubernetesListFile);
    // Then
  ...
  @Test
  public void deserializeKubernetesListOrTemplate_withStandardResourcesAndPlaceholders_returnsValidList() throws IOException, URISyntaxException {
    // Given
    final File kubernetesListFile = resourceTestFile(
            "/util/resource-util/list-with-standard-resources-and-placeholders.yml");
    // When
    final List<HasMetadata> result = ResourceUtil.deserializeKubernetesListOrTemplate(
        kubernetesListFile);
    // Then
  ...
  @Test
  public void deserializeKubernetesListOrTemplate_withSingleResource_returnsValidList() throws IOException, URISyntaxException {
    // Given
    final File kubernetesListFile = resourceTestFile("/util/resource-util/custom-resource-cr.yml");
    // When
    final List<HasMetadata> result = ResourceUtil.deserializeKubernetesListOrTemplate(
        kubernetesListFile);
    // Then
  ...
  public void load_withCustomResourceFile_shouldLoadGenericKubernetesResource() throws Exception {
    ...
    final HasMetadata result = ResourceUtil.load(
        resourceTestFile("/util/resource-util/custom-resource-cr.yml"),
        HasMetadata.class);
    // Then
    assertThat(result)
        .isInstanceOf(GenericKubernetesResource.class)
  ...
  public void load_withTemplate_shouldLoadTemplate() throws Exception {
    // When
    final HasMetadata result = ResourceUtil.load(
        resourceTestFile("/util/resource-util/template.yml"),
        HasMetadata.class);
    // Then
    assertThat(result)
  ...
  @Test
  public void save_withValidYamlFileAndItem_shouldSave() throws IOException, URISyntaxException {
    // Given
    ...
    assertThat(file).hasSameTextualContentAs(
        resourceTestFile("/util/resource-util/expected/config-map-simple.yml"));
  }

  @Test
  public void save_withValidJsonFileAndItem_shouldSave() throws IOException, URISyntaxException {
    // Given
    ...
    // Then
    assertThat(file).hasSameTextualContentAs(
        resourceTestFile("/util/resource-util/expected/config-map-simple.json"));
  }

  @Test
  public void save_withValidYamlFileAndItemWithAdditionalProperties_shouldSave() throws IOException, URISyntaxException {
    // Given
    final File file = temporaryFolder.newFile("temp-resource.yaml");
    final ConfigMap resource = new ConfigMapBuilder().withNewMetadata().withName("cm").endMetadata()
    ...
    // Then
    assertThat(file).hasSameTextualContentAs(
        resourceTestFile("/util/resource-util/expected/config-map-placeholders.yml"));
  }

  private static File resourceTestFile(String path) throws URISyntaxException {
    final URL fileUrl = ResourceUtilTest.class.getResource(path);
