...
class GitUtilTest {
  ...
  @CsvSource({
      ...
      "https://q@some.host:443,https://some.host:443.git",
      "https://@some.host/foo/bar, https://some.host/foo/bar.git",
      ...
      "ssh://user@host.xz:8080/path/to/repo.git, https://host.xz:8080/path/to/repo.git",
      "ssh://user@host.xz/path/to/repo.git, https://host.xz/path/to/repo.git",
      ...
      "ssh://user@host.xz/~user/path/to/repo.git, https://host.xz/~user/path/to/repo.git",
      ...
      "user@host.xz:path/to/repo.git, https://host.xz/path/to/repo.git",
      "user@host.xz:~user/path/to/repo.git, https://host.xz/~user/path/to/repo.git",
      "host.xz:~user/path/to/repo.git, host.xz:~user/path/to/repo.git",
      "https://[::1]:456, https://[::1]:456.git"
  })
