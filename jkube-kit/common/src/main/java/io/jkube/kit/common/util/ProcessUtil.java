...
import static io.jkube.kit.common.util.EnvUtil.isWindows;
...
public class ProcessUtil {
    ...
    public static boolean folderIsOnPath(KitLogger logger, File dir) {
        ...
        if (paths.size() == 0) {
            ...
            logger.warn("Please report this to the jkube team: https://github.com/fabric8io/jkube-maven-plugin/issues/new");
            return false;
        }
