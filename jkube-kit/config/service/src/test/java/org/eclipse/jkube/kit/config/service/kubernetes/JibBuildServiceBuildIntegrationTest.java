...
public class JibBuildServiceBuildIntegrationTest {
  ...
  public void setUp() throws Exception {
    ...
    // @formatter:on
    jibBuildService = new JibBuildService();
  }
  ...
  public void build_dockerFileMode_shouldThrowException() {
    ...
    final ImageConfiguration ic = imageConfiguration.toBuilder()
        ...
        .build();
    // When
    final JKubeServiceException result = assertThrows(JKubeServiceException.class, () -> jibBuildService.build(hub, ic));
    // Then
