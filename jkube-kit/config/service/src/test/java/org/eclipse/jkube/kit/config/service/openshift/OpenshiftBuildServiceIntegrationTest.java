...
public class OpenshiftBuildServiceIntegrationTest {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(OpenshiftBuildServiceIntegrationTest.class);
    ...
    public void testSuccessfulBuild() throws Exception {
        retryInMockServer(() -> {
            ...
            new OpenshiftBuildService().build(jKubeServiceHub, image);
    ...
    public void testDockerBuildFromExt() throws Exception {
        retryInMockServer(() -> {
            ...
            OpenshiftBuildService service = new OpenshiftBuildService();
            ...
            service.build(jKubeServiceHub, fromExtImage);
    ...
    public void testFailedBuild() {
        ...
        final OpenshiftBuildService openshiftBuildService = new OpenshiftBuildService();

        final JKubeServiceException result = assertThrows(JKubeServiceException.class, () ->
            openshiftBuildService.build(jKubeServiceHub, image));
    ...
    /**
     * Helper method to verify request url path
     */
    private Boolean containsRequest(String path)   {
        try {
            MockWebServer mock = mockServer.getMockServer();
