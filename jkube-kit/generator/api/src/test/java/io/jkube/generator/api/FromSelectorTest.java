...
import static io.jkube.kit.config.image.build.OpenShiftBuildStrategy.s2i;
import static io.jkube.kit.config.image.build.OpenShiftBuildStrategy.docker;
import static io.jkube.kit.config.resource.RuntimeMode.openshift;
