...
abstract class AbstractAwsSdkHelper implements AwsSdkAuthHelper {
  ...
  protected AbstractAwsSdkHelper() {
    this(SystemEnvironment.getInstance());
  }

  protected AbstractAwsSdkHelper(Environment environment) {
    this.environment = environment;
  }

  @Override
  public String getAwsAccessKeyIdEnvVar() {
    return environment.getEnv(ACCESS_KEY_ID);
  }

  @Override
  public String getAwsSecretAccessKeyEnvVar() {
    return environment.getEnv(SECRET_ACCESS_KEY);
  }

  @Override
  public String getAwsSessionTokenEnvVar() {
    return environment.getEnv(SESSION_TOKEN);
  }

  @Override
  public String getAwsContainerCredentialsRelativeUri() {
    return environment.getEnv(CONTAINER_CREDENTIALS_RELATIVE_URI);
  }

  @Override
  public String getEcsMetadataEndpoint() {
    String endpoint = environment.getEnv(METADATA_ENDPOINT);
    if (endpoint == null) {
