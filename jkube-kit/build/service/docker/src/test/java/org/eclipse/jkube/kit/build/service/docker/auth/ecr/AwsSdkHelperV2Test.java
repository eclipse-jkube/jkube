...
/**
 * Tests for AwsSdkHelperV2.
 * Note: These tests verify the helper's behavior when AWS SDK v2 classes are NOT available.
 * Full integration testing with actual AWS SDK v2 would require adding the dependency.
 */
class AwsSdkHelperV2Test {
  ...
  void isAwsSdkAvailable_returnsFalseWhenSdkNotInClasspath() {
    // AWS SDK v2 is not in the test classpath
  ...
  void getCredentialsFromDefaultCredentialsProvider_returnsNullWhenSdkNotAvailable() {
    // When AWS SDK v2 is not in classpath, should return null
