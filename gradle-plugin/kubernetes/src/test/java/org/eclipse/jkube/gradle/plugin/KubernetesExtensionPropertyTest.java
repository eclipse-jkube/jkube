...
class KubernetesExtensionPropertyTest {
  ...
  static Stream<Arguments> defaultValues() {
    return Stream.of(
        ...
        arguments("getAllowInsecureRegistriesOrDefault", false),
        ...
        arguments("getRegistryOrDefault", null),
        arguments("getPullRegistryOrDefault", null),
  ...
  static Stream<Arguments> propertiesAndValues() {
    return Stream.of(
        ...
        arguments("getAllowInsecureRegistriesOrDefault", "jkube.docker.allowInsecureRegistries", "true", true),
