...
class MicronautPropertiesIT {
  ...
  void k8sResource_whenRun_generatesK8sManifestsWithProbes() throws IOException, ParseException {
    // When
    final BuildResult result = gradleRunner.withITProject("micronaut-properties")
    ...
    assertThat(result).extracting(BuildResult::getOutput).asString()
        ...
        .contains("jkube-healthcheck-micronaut: Adding readiness probe on port 9080")
        .contains("jkube-healthcheck-micronaut: Adding liveness probe on port 9080")
