...
@DisplayName("Route can have name overridden by service configuration when there's a route fragment")
class RouteNameAndFragmentIT {

  private static final String TEST_PROJECT = "route-name-fragment";
