...
class SpringBootManagementHealthProbesIT {
  @RegisterExtension
  protected final ITGradleRunnerExtension gradleRunner = new ITGradleRunnerExtension();

  @Test
  void k8sResource_whenRun_generatesK8sManifestsWithProbesWithSpecificEndpoints() throws IOException, ParseException {
    // When
    final BuildResult result = gradleRunner.withITProject("spring-boot-managementhealthprobes")
  ...
  @Test
  void ocResource_whenRun_generatesK8sManifestsWithProbesWithSpecificEndpoints() throws IOException, ParseException {
    // When
    final BuildResult result = gradleRunner.withITProject("spring-boot-managementhealthprobes")
