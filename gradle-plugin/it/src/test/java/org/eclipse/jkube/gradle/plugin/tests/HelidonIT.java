...
class HelidonIT {
  ...
  void k8sResource_whenRun_generatesK8sManifestsWithProbes() throws IOException, ParseException {
    // When
    final BuildResult result = gradleRunner.withITProject("helidon")
    ...
    assertThat(result).extracting(BuildResult::getOutput).asString()
        ...
        .contains("jkube-healthcheck-helidon: Adding readiness probe on port 8080")
        .contains("jkube-healthcheck-helidon: Adding liveness probe on port 8080")
