...
class GitAnnotationsIT {
  @RegisterExtension
  private final ITGradleRunnerExtension gradleRunner = new ITGradleRunnerExtension();

  @Test
  void k8sResource_whenRun_generatesK8sManifestsWithGitAnnotations() throws IOException, ParseException {
    // When
  ...
  @Test
  void ocResource_whenRun_generatesOpenShiftManifestsWithGitAnnotations() throws IOException, ParseException {
    // When
