...
You can find all Groovy DSL configuration options for {task-prefix}Resource in <<kubernetes-resource-configuration, Kubernetes Resource configuration>> section.
